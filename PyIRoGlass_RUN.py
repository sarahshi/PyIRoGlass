...
PATHS = [path_input + string for string in ['SampleSpectra/Fuego/', 'SampleSpectra/Standards/', 'SampleSpectra/Fuego1974RH/', 'SampleSpectra/SIMS/']]
...
INPUT_PATHS = [['FUEGO_F'], ['STD_F'], ['FRH_F'], ['SIMS_F']]
