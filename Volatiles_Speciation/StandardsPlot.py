...
MEGA_SPREADSHEET = pd.read_csv('../FINALDATA/' + 'SNew' + '_H2OCO2_FwSTD.csv', index_col = 0)
...
ax[0].scatter(H2O_expmean(Fiege73), H2O_mean(Fiege73), s=sz, marker='D', c='#fee392', ec='#171008', lw=0.5, zorder=15, label='ABWB-0x')
...
ax[0].scatter(H2O_expmean(BF73), H2O_mean(BF73), s=sz, marker='D', c='#fec44f', ec='#171008', lw=0.5, zorder=20, label='BF73')
ax[0].errorbar(H2O_expmean(BF73), H2O_mean(BF73), xerr=H2O_expstd(BF73), yerr=H2O_mean(BF73)*H2O_rsd(BF73), lw=0.5, c='k', zorder=10)

ax[0].scatter(H2O_expmean(BF76), H2O_mean(BF76), s=sz, marker='D', c='#fb9a29', ec='#171008', lw=0.5, zorder=20, label='BF76')
ax[0].errorbar(H2O_expmean(BF76), H2O_mean(BF76), xerr=H2O_expstd(BF76), yerr=H2O_mean(BF76)*H2O_rsd(BF76), lw=0.5, c='k', zorder=10)

ax[0].scatter(H2O_expmean(BF77), H2O_mean(BF77), s=sz, marker='D', c='#ec7014', ec='#171008', lw=0.5, zorder=20, label='BF77')
...
ax[0].scatter(H2O_expmean(M35), H2O_mean(M35), s=sz, marker='D', c='#983404', ec='#171008', lw=0.5, zorder=20, label='M35')
ax[0].errorbar(H2O_expmean(M35), H2O_mean(M35), xerr=H2O_expstd(M35), yerr=H2O_mean(M35)*H2O_rsd(M35), lw=0.5, c='k', zorder=10)

ax[0].scatter(H2O_expmean(M43), H2O_mean(M43), s=sz, marker='D', c='#662506', ec='#171008', lw=0.5, zorder=20, label='M43')
...
l1 = ax[0].legend(loc='lower right', labelspacing = 0.3, handletextpad = 0.3, handlelength = 1.00, prop={'size': 10.5}, frameon=False)
...
kft_sym = ax[0].scatter(np.nan, np.nan, s=sz, marker='D', ec='#171008', facecolors='white', lw=0.5, zorder=20, label='KFT')
...
ax[0].legend([ftir_sym, sims_sym, kft_sym, ea_sym, erda_sym, nra_sym, sat_symb], ['FTIR', 'SIMS', 'KFT', 'EA', 'ERDA', 'NRA', '$\mathregular{H_2O_{t, 3550}}$ Saturated'], loc=(0.0025, 0.46), labelspacing = 0.3, handletextpad = 0.25, handlelength = 1.00, prop={'size': 11}, frameon=True)
ax[0].add_artist(l1)
...
ax[1].scatter(CO2_expmean(INSOL), CO2_mean(INSOL), s=sz+15, marker='8', facecolors='#fff7bc', ec='#171008', lw=0.5, zorder=20, label='INSOL') 
...
inset_ax.set_xlim([0, 0.02])  # Adjust the x-axis limits to zoom in on values < 0.05
inset_ax.set_ylim([0, 0.02])  # Adjust the y-axis limits similarly if needed
...
ax[1].legend(loc='lower right', labelspacing = 0.3, handletextpad = 0.3, handlelength = 1.00, prop={'size': 10.5}, frameon=False)
...
plt.tight_layout()
plt.savefig('FTIRSIMS_Comparison_ND70_2.pdf', bbox_inches='tight', pad_inches=0.025)
plt.show()
