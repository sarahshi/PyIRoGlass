...
PATHS = [path_beg+'Inputs/SampleSpectra/Fuego/', path_beg+'Inputs/SampleSpectra/Standards/', path_beg+'Inputs/SampleSpectra/Fuego1974RH/', 
    path_beg+'Inputs/SampleSpectra/Henry/']
THICKNESS_PATH = [path_beg+'Inputs/FuegoThickness.csv', path_beg+'Inputs/StandardThickness.csv', path_beg+'Inputs/DanRHThickness.csv', 
    path_beg+'Inputs/ND70_6_02_Thickness.csv']
MICOMP_PATH = [path_beg+'Inputs/FuegoChemistry_NEW_H2O_Fe2O3.csv', path_beg+'Inputs/StandardChemistry.csv', path_beg+'Inputs/DanRHChemistry.csv', 
    path_beg+'Inputs/ND70_6_02_Chemistry.csv']
INPUT_PATHS = [[path_beg+"Inputs/Baseline_Avg+PCA.csv", path_beg+"Inputs/Water_Peak_1635_All.csv", 'FUEGO_F'], 
    [path_beg+"Inputs/Baseline_Avg+PCA.csv", path_beg+"Inputs/Water_Peak_1635_All.csv", 'STD_F'], 
    [path_beg+"Inputs/Baseline_Avg+PCA.csv", path_beg+"Inputs/Water_Peak_1635_All.csv", 'FRH_F'],
    [path_beg+"Inputs/Baseline_Avg+PCA.csv", path_beg+"Inputs/Water_Peak_1635_All.csv", 'Henry']]
OUTPUT_PATH = ['F18', 'STD', 'FRH', 'Henry']

i = 3 # int(sys.argv[1]) - 1
...
DF_OUTPUT = pd.read_csv(path_beg + output_dir[-1] + '/' + OUTPUT_PATH[i] + '_DF_F.csv', index_col = 0 )
...
# print(PATHS[i] + " done! Time: " + str(time.time() - start_time) + "s")
...
# for i in MEGA_SPREADSHEET.index: 
...
#         CO2_EXP = 64	
#         CO2_EXP_STD = 6.4
#     elif 'ALV1833-11' in i: x
#         H2O_EXP = 1.2
#         H2O_EXP_STD = 0.12
#         CO2_EXP = 102
#         CO2_EXP_STD = 10.2
#     elif 'CD33_12-2-2' in i: 
#         H2O_EXP = 0.27
#         H2O_EXP_STD = 0.03
#         CO2_EXP = 170
#         CO2_EXP_STD = 17
#     elif 'CD33_22-1-1' in i: 
#         H2O_EXP = 0.49
#         H2O_EXP_STD = 0.05
#         CO2_EXP = 109
#         CO2_EXP_STD = 10.9
...
#         CO2_EXP = np.nan
#         CO2_EXP_STD = np.nan
#     elif 'VF74_127-7' in i: 
#         H2O_EXP = 3.98
#         H2O_EXP_STD = 0.39
#         CO2_EXP = 439
#         CO2_EXP_STD = 43.9
#     elif 'VF74_131-1' in i: 
#         H2O_EXP = np.nan
#         H2O_EXP_STD = np.nan
#         CO2_EXP = np.nan
#         CO2_EXP_STD = np.nan
#     elif 'VF74_131-9' in i: 
#         H2O_EXP = np.nan
#         H2O_EXP_STD = np.nan
#         CO2_EXP = np.nan
#         CO2_EXP_STD = np.nan
#     elif 'VF74_132-1' in i: 
#         H2O_EXP = np.nan
#         H2O_EXP_STD = np.nan
#         CO2_EXP = np.nan
#         CO2_EXP_STD = np.nan
#     elif 'VF74_132-2' in i: 
#         H2O_EXP = 3.91
#         H2O_EXP_STD = 0.39
#         CO2_EXP = 198
#         CO2_EXP_STD = 19.8
#     elif 'VF74-134D-15' in i: 
#         H2O_EXP = np.nan
#         H2O_EXP_STD = np.nan
#         CO2_EXP = np.nan
#         CO2_EXP_STD = np.nan
#     elif 'VF74-136-3' in i: 
#         H2O_EXP = np.nan
#         H2O_EXP_STD = np.nan
#         CO2_EXP = np.nan
#         CO2_EXP_STD = np.nan
...
# MEGA_SPREADSHEET1.to_csv('H2OCO2_FwSTD.csv')
